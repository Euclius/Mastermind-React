...
// when you fetch, it is a two step process, 1st it connects and gets header and setup information then another function is needed, the json, to get the actual body
